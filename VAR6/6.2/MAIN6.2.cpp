...
int main() {
    ...
    createFileWithIntegers(fileName1, 12); //Сгенерировать файл с целыми числами
    rewriteTwoByTwo(fileName1, fileName2); //Получить отсортированный файл
    createBinFileWithIntegers(fileNameBin1, 12); //Сгенерировать двоичный файл с целыми числами

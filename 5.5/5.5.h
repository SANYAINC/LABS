...
void solveNewton(double (*funcPtr)(char, double, double), double inf = 0, double sup = 1.5, double x0 = 0.01, double epsilon = 1E-6, double paramInf = 0.95, double paramSup = 1.2, double deltaParam = 0.05);
//Решение методом половинного деления
//Можно использовать когда точно известно что на промежутке есть единственный корень
void solveHalfDivision(double (*funcPtr)(char, double), double inf = 1, double sup = 4, double epsilon = 1E-6);
void solveHalfDivision(double (*funcPtr)(char, double, double), double inf = 0, double sup = 1.5 , double epsilon = 1E-6, double paramInf = 0.95, double paramSup = 1.2, double deltaParam = 0.05);

...
double calcIntegralMR(double (*func)(double, double, double), double leftBorder, double rightBorder, double paramS, double paramT, int N) {
...
double calcIntegralT(double (*func)(double, double, double), double leftBorder, double rightBorder, double paramS, double paramT, int N) {
    double xi = leftBorder;
    double dx = (rightBorder - leftBorder) / N;
    double integral = 0;
